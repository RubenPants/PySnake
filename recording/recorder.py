"""  TODO: Do we wanna keep it? Think of a way to change it then
recorder.py
...
#         'duration':            duration,
#     }
#     n = len(glob(f"recording/data/{pre}*"))
...
#     recordings = []
#
#     # Load all random recordings; first to learn walls are bad
#     recordings += glob("recording/data/random*")
#
#     # Load all A* recordings; second to learn apple is life
